      ...
      switch (subcommand) {
        ...
        default:
          await respond({
            text: '📋 **アンケート機能の使用方法**\n\n' +
                  '**基本操作:**\n' +
                  '• `/survey` - 📝 アクティブなアンケート一覧表示\n' +
                  '• `/survey create` - ✨ 新しいアンケートを作成\n' +
                  '• `/survey templates` - 📚 利用可能なテンプレート一覧\n' +
                  '• `/survey my` - 👤 自分が作成したアンケート一覧\n\n' +
                  '**管理・分析:**\n' +
                  '• `/survey stats [survey_id]` - 📊 アンケート統計・回答状況\n' +
                  '• `/survey remind [survey_id]` - 📢 未回答者にリマインダー送信\n' +
                  '• `/survey nonresponders [survey_id]` - 📋 未回答者一覧表示\n\n' +
                  '💡 **ヒント:** アンケートIDは一覧表示で確認できます',
